...
If you're set on Markdown, then the question is how to generate a presentable PDF. Pandoc is a great tool for this but getting it set up and managing the formatting can get [rather complicated](https://github.com/mszep/pandoc-resume). I've been searching for a way to get a good result with as few moving parts as possible and here's what I've settled on for now.
